...
<img src="string_and_factor_files/figure-gfm/unnamed-chunk-13-2.png" width="90%" />
...
# for linear regression, R is taking the first one as the control group to make comparison with
